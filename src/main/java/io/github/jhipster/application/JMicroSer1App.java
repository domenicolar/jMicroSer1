...
public class JMicroSer1App {

    private static final Logger log = LoggerFactory.getLogger(JMicroSer1App.class);

    private final Environment env;

    public JMicroSer1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jMicroSer1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JMicroSer1App.class);
